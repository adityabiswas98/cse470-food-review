...
<head>
    ...
    <style>
        ...
        body { 
          background: url(images/restaurent.png) no-repeat center center fixed; 
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/">Are You a Customer?</a>
                    </li>
                    @else
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ownerSignout') }}">Logout</a>
                    </li>
                    @endguest
                </ul>
            </div>
